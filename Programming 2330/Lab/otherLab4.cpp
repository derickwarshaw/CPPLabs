// Derick Warshaw
// Lab #4 Volume Calculator for Snowm an Family
...
int main()
	{
		...
		double mommaVolume1 = 0;
		double mommaVolume2 = 0;
		double mommaVolume3 = 0;
		
		double papaVolume1 = 0;
		double papaVolume2 = 0;
		double papaVolume3 = 0;
		
		double babyVolume1 = 0;
		double babyVolume2 = 0;
		double babyVolume3 = 0;
